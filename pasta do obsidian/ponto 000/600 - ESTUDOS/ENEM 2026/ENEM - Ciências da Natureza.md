---
tags: [estudos, enem, natureza, biologia, fisica, quimica, cor/ciano-50-200-220]
...
**Dica**: Foco em contextualização! O ENEM cobra conceitos aplicados ao cotidiano.
...
### Evolução
- [ ] Teorias evolutivas (Lamarck vs Darwin)
- [ ] Seleção natural
- [ ] Especiação
...
### Ecologia
- [ ] Níveis de organização (população, comunidade, ecossistema)
- [ ] Cadeias e teias alimentares
- [ ] Ciclos biogeoquímicos (água, carbono, nitrogênio)
- [ ] Relações ecológicas
- [ ] Sucessão ecológica
- [ ] Biomas brasileiros
- [ ] Impactos ambientais (desmatamento, poluição, aquecimento)
...
### Saúde e Doenças
- [ ] Doenças virais (dengue, COVID, AIDS)
- [ ] Doenças bacterianas
...
### Ondulatória
- [ ] Ondas (conceitos, tipos)
- [ ] Som (frequência, intensidade)
- [ ] Luz (natureza ondulatória)
...
### Físico-Química
- [ ] Estequiometria
- [ ] Soluções (concentração, diluição)
...
- [ ] Funções orgânicas (álcoois, aldeídos, cetonas, ácidos, ésteres, aminas)
- [ ] Nomenclatura IUPAC
- [ ] Isomeria
- [ ] Reações orgânicas
...
```
Cinemática:
v = Δs/Δt | a = Δv/Δt | S = S₀ + v₀t + ½at²

Dinâmica:
F = m.a | P = m.g | Fat = μ.N

Energia:
Ec = ½mv² | Ep = mgh | W = F.d.cosθ
